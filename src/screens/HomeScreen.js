            ...
            <Container style={{flex: 1}}>
                <View style={{flex: 1}}>
                    ...
                    <View style={{position: 'absolute', top: 0, left: 0,right:0,bottom:0,backgroundColor : this.theme.primaryTransparent}}>
                        ...
                        {PUBLIC_ACCESS ? ( <Button onPress={() => this.props.navigation.navigate(DEFAULT_HOME)} block danger style={{position:'absolute',bottom:10,width:'100%',backgroundColor:'none'}}>
